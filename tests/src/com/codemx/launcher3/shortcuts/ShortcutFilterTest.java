...
public class ShortcutFilterTest {
    ...
    public void testSortAndFilterShortcuts() {
        ...
        filterShortcutsAndAssertNumStaticAndDynamic(createShortcutsList(5, 0), ShortcutFilter.MAX_SHORTCUTS, 0);
        filterShortcutsAndAssertNumStaticAndDynamic(createShortcutsList(0, 5), 0, ShortcutFilter.MAX_SHORTCUTS);
        filterShortcutsAndAssertNumStaticAndDynamic(createShortcutsList(3, 3),
                ShortcutFilter.MAX_SHORTCUTS - ShortcutFilter.NUM_DYNAMIC, ShortcutFilter.NUM_DYNAMIC);
        filterShortcutsAndAssertNumStaticAndDynamic(createShortcutsList(5, 5),
                ShortcutFilter.MAX_SHORTCUTS - ShortcutFilter.NUM_DYNAMIC, ShortcutFilter.NUM_DYNAMIC);
        filterShortcutsAndAssertNumStaticAndDynamic(createShortcutsList(5, 1), ShortcutFilter.MAX_SHORTCUTS - 1, 1);
        filterShortcutsAndAssertNumStaticAndDynamic(createShortcutsList(1, 5), 1, ShortcutFilter.MAX_SHORTCUTS - 1);
