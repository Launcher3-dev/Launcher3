...
public class FolderIcon extends FrameLayout implements FolderInfo.FolderListener {
    ...
    public static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        icon.mFolderName = (BubbleTextView) icon.findViewById(com.android.launcher3.R.id.folder_icon_name);
        ...
        icon.setContentDescription(launcher.getString(com.android.launcher3.R.string.folder_name_format, folderInfo.title));
    ...
    public void onTitleChanged(CharSequence title) {
        ...
        setContentDescription(getContext().getString(com.android.launcher3.R.string.folder_name_format, title));
    }
