...
public class DragController implements DragDriver.EventListener, TouchController {
    ...
    public DragController(Launcher launcher) {
        ...
        mScrollZone = r.getDimensionPixelSize(com.android.launcher3.R.dimen.scroll_zone);
        mVelocityTracker = VelocityTracker.obtain();

        mFlingToDeleteThresholdVelocity =
                r.getDimensionPixelSize(com.android.launcher3.R.dimen.drag_flingToDeleteMinVelocity);
    ...
    public DragView startDrag(Bitmap b, int dragLayerX, int dragLayerY,
        ...
        final float scaleDps = FeatureFlags.LAUNCHER3_LEGACY_WORKSPACE_DND
                ? res.getDimensionPixelSize(com.android.launcher3.R.dimen.dragViewScale)
                : mIsDragDeferred
                    ? res.getDimensionPixelSize(com.android.launcher3.R.dimen.deferred_drag_view_scale)
                    : 0f;
