...
public class DeepShortcutView extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    protected void onFinishInflate() {
        ...
        mIconView = findViewById(com.android.launcher3.R.id.deep_shortcut_icon);
        mBubbleText = (DeepShortcutTextView) findViewById(com.android.launcher3.R.id.deep_shortcut);
    }
