...
public final class FeatureFlags {
    ...
    public static boolean showFlagTogglerUi(Context context) {
        return /*BuildConfig.IS_DEBUG_DEVICE*/ BuildConfig.DEBUG && Utilities.isDevelopersOptionsEnabled(context);
    }
     ...
     */
    @Deprecated
    public static final boolean IS_STUDIO_BUILD = BuildConfig.DEBUG; //BuildConfig.IS_STUDIO_BUILD;
