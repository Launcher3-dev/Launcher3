...
public class WidgetCell extends LinearLayout implements OnLayoutChangeListener {
    ...
    protected void onFinishInflate() {
        ...
        mWidgetImage = (WidgetImageView) findViewById(com.android.launcher3.R.id.widget_preview);
        mWidgetName = ((TextView) findViewById(com.android.launcher3.R.id.widget_name));
        mWidgetDims = ((TextView) findViewById(com.android.launcher3.R.id.widget_dims));
    }
    ...
    public void applyFromCellItem(WidgetItem item, WidgetPreviewLoader loader) {
        ...
        mWidgetDims.setText(getContext().getString(com.android.launcher3.R.string.widget_dims_format,
                mItem.spanX, mItem.spanY));
        mWidgetDims.setContentDescription(getContext().getString(
                com.android.launcher3.R.string.widget_accessible_dims_format, mItem.spanX, mItem.spanY));
