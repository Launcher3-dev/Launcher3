package com.codemx.launcher3.pageindicators;
...
public class PageIndicatorLineCaret extends PageIndicator {
    ...
    public PageIndicatorLineCaret(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLineHeight = res.getDimensionPixelSize(com.codemx.launcher3.R.dimen.dynamic_grid_page_indicator_line_height);
    ...
    protected void onFinishInflate() {
        ...
        mAllAppsHandle = (ImageView) findViewById(com.codemx.launcher3.R.id.all_apps_handle);
