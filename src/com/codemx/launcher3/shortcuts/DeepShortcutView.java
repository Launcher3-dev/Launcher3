...
import com.codemx.launcher3.shortcuts.DeepShortcutsContainer.UnbadgedShortcutInfo;
import com.codemx.launcher3.util.PillRevealOutlineProvider;
import com.codemx.launcher3.util.PillWidthRevealOutlineProvider;
...
public class DeepShortcutView extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    protected void onFinishInflate() {
        ...
        mIconView = findViewById(com.codemx.launcher3.R.id.deep_shortcut_icon);
        mBubbleText = (DeepShortcutTextView) findViewById(com.codemx.launcher3.R.id.deep_shortcut);
    }
