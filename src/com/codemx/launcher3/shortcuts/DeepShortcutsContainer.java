...
package com.codemx.launcher3.shortcuts;
...
import com.codemx.launcher3.DragSource;
import com.codemx.launcher3.DropTarget;
import com.codemx.launcher3.IconCache;
import com.codemx.launcher3.ItemInfo;
import com.codemx.launcher3.Launcher;
import com.codemx.launcher3.LauncherAnimUtils;
...
import com.codemx.launcher3.LauncherViewPropertyAnimator;
import com.codemx.launcher3.LogAccelerateInterpolator;
import com.codemx.launcher3.ShortcutInfo;
import com.codemx.launcher3.Utilities;
import com.codemx.launcher3.accessibility.ShortcutMenuAccessibilityDelegate;
import com.codemx.launcher3.compat.UserHandleCompat;
import com.codemx.launcher3.dragndrop.DragController;
import com.codemx.launcher3.dragndrop.DragLayer;
import com.codemx.launcher3.dragndrop.DragOptions;
import com.codemx.launcher3.dragndrop.DragView;
import com.codemx.launcher3.graphics.TriangleShape;
import com.codemx.launcher3.userevent.nano.LauncherLogProto;
...
public class DeepShortcutsContainer extends LinearLayout implements View.OnLongClickListener,
    ...
    public DeepShortcutsContainer(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStartDragThreshold = getResources().getDimensionPixelSize(
                com.codemx.launcher3.R.dimen.deep_shortcuts_start_drag_threshold);
    ...
    public void populateAndShow(final BubbleTextView originalIcon, final List<String> ids) {
        ...
        final int arrowWidth = resources.getDimensionPixelSize(com.codemx.launcher3.R.dimen.deep_shortcuts_arrow_width);
        final int arrowHeight = resources.getDimensionPixelSize(com.codemx.launcher3.R.dimen.deep_shortcuts_arrow_height);
        final int arrowHorizontalOffset = resources.getDimensionPixelSize(
                com.codemx.launcher3.R.dimen.deep_shortcuts_arrow_horizontal_offset);
        final int arrowVerticalOffset = resources.getDimensionPixelSize(
                com.codemx.launcher3.R.dimen.deep_shortcuts_arrow_vertical_offset);

        // Add dummy views first, and populate with real shortcut info when ready.
        final int spacing = getResources().getDimensionPixelSize(com.codemx.launcher3.R.dimen.deep_shortcuts_spacing);
        final LayoutInflater inflater = mLauncher.getLayoutInflater();
        int numShortcuts = Math.min(ids.size(), ShortcutFilter.MAX_SHORTCUTS);
        for (int i = 0; i < numShortcuts; i++) {
            final DeepShortcutView shortcut =
                    (DeepShortcutView) inflater.inflate(com.codemx.launcher3.R.layout.deep_shortcut, this, false);
            if (i < numShortcuts - 1) {
        ...
        setContentDescription(getContext().getString(com.codemx.launcher3.R.string.shortcuts_menu_description,
    ...
    private void animateOpen() {
        ...
        final long duration = getResources().getInteger(
                com.codemx.launcher3.R.integer.config_deepShortcutOpenDuration);
        final long arrowScaleDuration = getResources().getInteger(
                com.codemx.launcher3.R.integer.config_deepShortcutArrowOpenDuration);
        final long arrowScaleDelay = duration - arrowScaleDuration;
        final long stagger = getResources().getInteger(
                com.codemx.launcher3.R.integer.config_deepShortcutOpenStagger);
        ...
        shortcutAnims.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                Utilities.sendCustomAccessibilityEvent(
                        ...
                        getContext().getString(com.codemx.launcher3.R.string.action_deep_shortcut));
            }
        });
    ...
    private void orientAboutIcon(BubbleTextView icon, int arrowHeight) {
        ...
        if (isAlignedWithStart()) {
            ...
            int shortcutIconWidth = resources.getDimensionPixelSize(com.codemx.launcher3.R.dimen.deep_shortcut_icon_size);
            int shortcutPaddingStart = resources.getDimensionPixelSize(
                    com.codemx.launcher3.R.dimen.deep_shortcut_padding_start);
            xOffset = iconWidth / 2 - shortcutIconWidth / 2 - shortcutPaddingStart;
        } else {
            // Aligning with the drag handle.
            int shortcutDragHandleWidth = resources.getDimensionPixelSize(
                    com.codemx.launcher3.R.dimen.deep_shortcut_drag_handle_size);
            int shortcutPaddingEnd = resources.getDimensionPixelSize(
                    com.codemx.launcher3.R.dimen.deep_shortcut_padding_end);
    ...
    public void animateClose() {
        ...
        final long duration = getResources().getInteger(
                com.codemx.launcher3.R.integer.config_deepShortcutCloseDuration);
        final long arrowScaleDuration = getResources().getInteger(
                com.codemx.launcher3.R.integer.config_deepShortcutArrowOpenDuration);
        final long stagger = getResources().getInteger(
                com.codemx.launcher3.R.integer.config_deepShortcutCloseStagger);
        final TimeInterpolator fadeInterpolator = new LogAccelerateInterpolator(100, 0);
        ...
        if (!ids.isEmpty()) {
            ...
            final DeepShortcutsContainer container =
                    (DeepShortcutsContainer) launcher.getLayoutInflater().inflate(
                            com.codemx.launcher3.R.layout.deep_shortcuts_container, launcher.getDragLayer(), false);
