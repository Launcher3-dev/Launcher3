...
import com.codemx.launcher3.Hotseat;
...
public class AllAppsTransitionController implements TouchController, VerticalPullDetector.Listener,
    ...
    public AllAppsTransitionController(Launcher l) {
        ...
        mBezelSwipeUpHeight = l.getResources().getDimensionPixelSize(
                com.codemx.launcher3.R.dimen.all_apps_bezel_swipe_height);

        mEvaluator = new ArgbEvaluator();
        mAllAppsBackgroundColor = ContextCompat.getColor(l, com.codemx.launcher3.R.color.all_apps_container_color);
    }
    ...
    public void showDiscoveryBounce() {
        ...
        mDiscoBounceAnimation = (AnimatorSet) AnimatorInflater.loadAnimator(mLauncher,
                com.codemx.launcher3.R.anim.discovery_bounce);
