...
import com.codemx.launcher3.BaseRecyclerView;
...
public abstract class HeaderElevationController extends RecyclerView.OnScrollListener {
    ...
    public static class ControllerV16 extends HeaderElevationController {
        ...
        public ControllerV16(View header) {
            ...
            mScrollToElevation = res.getDimension(com.codemx.launcher3.R.dimen.all_apps_header_scroll_to_elevation);
            ...
            FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(
                    ...
                    res.getDimensionPixelSize(com.codemx.launcher3.R.dimen.all_apps_header_shadow_height));
    ...
    public static class ControllerVL extends HeaderElevationController {
        ...
        public ControllerVL(View header) {
            ...
            mMaxElevation = res.getDimension(com.codemx.launcher3.R.dimen.all_apps_header_max_elevation);
            mScrollToElevation = res.getDimension(com.codemx.launcher3.R.dimen.all_apps_header_scroll_to_elevation);
