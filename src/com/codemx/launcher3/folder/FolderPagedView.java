...
import com.codemx.launcher3.InvariantDeviceProfile;
...
import com.codemx.launcher3.PagedView;
...
import com.codemx.launcher3.FocusHelper;
...
public class FolderPagedView extends PagedView {
    ...
    public FolderPagedView(Context context, AttributeSet attrs) {
        ...
        setEdgeGlowColor(getResources().getColor(com.codemx.launcher3.R.color.folder_edge_effect_color));
    ...
    public void setFolder(Folder folder) {
        ...
        mPageIndicator = (PageIndicator) folder.findViewById(com.codemx.launcher3.R.id.folder_page_indicator);
    ...
    public View createNewView(ShortcutInfo item) {
        final BubbleTextView textView = (BubbleTextView) mInflater.inflate(
                com.codemx.launcher3.R.layout.folder_application, null, false);
    ...
    public String getAccessibilityDescription() {
        return getContext().getString(com.codemx.launcher3.R.string.folder_opened, mGridCountX, mGridCountY);
    }
