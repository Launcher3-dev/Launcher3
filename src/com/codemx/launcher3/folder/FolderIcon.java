...
package com.codemx.launcher3.folder;
...
import com.codemx.launcher3.OnAlarmListener;
import com.codemx.launcher3.PreloadIconDrawable;
import com.codemx.launcher3.ShortcutInfo;
import com.codemx.launcher3.SimpleOnStylusPressListener;
import com.codemx.launcher3.StylusEventHelper;
...
public class FolderIcon extends FrameLayout implements FolderInfo.FolderListener {
    ...
    public static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        icon.mFolderName = (BubbleTextView) icon.findViewById(com.codemx.launcher3.R.id.folder_icon_name);
        ...
        icon.setContentDescription(launcher.getString(com.codemx.launcher3.R.string.folder_name_format, folderInfo.title));
    ...
    public void onTitleChanged(CharSequence title) {
        ...
        setContentDescription(getContext().getString(com.codemx.launcher3.R.string.folder_name_format, title));
    }
