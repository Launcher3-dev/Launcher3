...
package com.codemx.launcher3.widget;
...
import com.codemx.launcher3.WidgetPreviewLoader;
...
import com.codemx.launcher3.util.TransformingTouchDelegate;
...
public class WidgetsContainerView extends BaseContainerView
    ...
    protected void onFinishInflate() {
        ...
        mRecyclerView = (WidgetsRecyclerView) getContentView().findViewById(com.codemx.launcher3.R.id.widgets_list_view);
    ...
    public void onClick(View v) {
        ...
        CharSequence msg = Utilities.wrapForTts(
                getContext().getText(com.codemx.launcher3.R.string.long_press_widget_to_add),
                getContext().getString(com.codemx.launcher3.R.string.long_accessible_way_to_add));
    ...
    private boolean beginDraggingWidget(WidgetCell v) {
        ...
        WidgetImageView image = (WidgetImageView) v.findViewById(com.codemx.launcher3.R.id.widget_preview);
    ...
    public void addWidgets(WidgetsModel model) {
        ...
        View loader = getContentView().findViewById(com.codemx.launcher3.R.id.loader);
        if (loader != null) {
