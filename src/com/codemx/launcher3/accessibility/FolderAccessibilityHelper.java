...
import com.codemx.launcher3.folder.FolderPagedView;
...
public class FolderAccessibilityHelper extends DragAndDropAccessibilityDelegate {
    ...
    protected String getLocationDescriptionForIconDrop(int id) {
        return mContext.getString(com.codemx.launcher3.R.string.move_to_position, id + mStartPosition + 1);
    }

    @Override
    protected String getConfirmationForIconDrop(int id) {
        return mContext.getString(com.codemx.launcher3.R.string.item_moved);
    }
}
