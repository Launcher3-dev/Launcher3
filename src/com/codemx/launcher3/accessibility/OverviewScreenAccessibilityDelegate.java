...
public class OverviewScreenAccessibilityDelegate extends AccessibilityDelegate {
    ...
    private static final int MOVE_BACKWARD = com.codemx.launcher3.R.id.action_move_screen_backwards;
    private static final int MOVE_FORWARD = com.codemx.launcher3.R.id.action_move_screen_forwards;
    ...
    public OverviewScreenAccessibilityDelegate(Workspace workspace) {
        ...
        mActions.put(MOVE_BACKWARD, new AccessibilityAction(MOVE_BACKWARD,
                context.getText(isRtl ? com.codemx.launcher3.R.string.action_move_screen_right :
                    com.codemx.launcher3.R.string.action_move_screen_left)));
        mActions.put(MOVE_FORWARD, new AccessibilityAction(MOVE_FORWARD,
                context.getText(isRtl ? com.codemx.launcher3.R.string.action_move_screen_left :
                    com.codemx.launcher3.R.string.action_move_screen_right)));
    }
    ...
    private void movePage(int finalIndex, View view) {
        ...
        mWorkspace.announceForAccessibility(mWorkspace.getContext().getText(com.codemx.launcher3.R.string.screen_moved));
