...
public class OverviewAccessibilityDelegate extends AccessibilityDelegate {
    ...
    private static final int OVERVIEW = com.codemx.launcher3.R.string.accessibility_action_overview;
    private static final int WALLPAPERS = com.codemx.launcher3.R.string.wallpaper_button_text;
    private static final int WIDGETS = com.codemx.launcher3.R.string.widget_button_text;
    private static final int SETTINGS = com.codemx.launcher3.R.string.settings_button_text;
